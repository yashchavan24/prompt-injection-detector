...
print("Extracting features + embeddings (cached from before conceptually, re-run here)...")
...
def run_rf_test(train_source, test_source):
...
print("=" * 60)
run_rf_test("deepset", "safeguard")
print("=" * 60)
run_rf_test("safeguard", "deepset")
